...
gives you a score, surrogates, z-score, and p-value in one call.
Config-list wrappers let you define parameters once and apply them
across subjects. And
...
#> 1       1 44.81143 9.765625 4.082184        TRUE
#> 2       2 48.91388 9.765625 4.250712        TRUE
#> 3       3 40.35858 9.765625 3.295853        TRUE
#> 4       4 26.09299 9.765625 2.609394        TRUE
#> 5       5 26.60936 9.765625 2.670983        TRUE
```

![Oscillation scores across subjects with significant results
highlighted in
blue.](workflow-wrappers_files/figure-html/plot-batch-1.png)

Oscillation scores across subjects with significant results highlighted
in blue.
...
#> [1] 0.06 0.07 0.06 0.06 0.05 0.05 0.07 0.18 1.52
...
#> 1 43.85796 10.13184 1.681614 10.65022
...
#> 1 4.90813 7.324219    5 10.50972 0.3146127 0.3765279       FALSE
```
...
head(spec_df)
#>       freq        power
#> 1 1.708984 1.338058e-04
#> 2 1.831055 1.166433e-04
#> 3 1.953125 9.469540e-05
#> 4 2.075195 8.186402e-05
#> 5 2.197266 7.682177e-05
#> 6 2.319336 6.915301e-05
